...
//resistor terminals
ctx.fillStyle = "red";
roundRect(145, 58, 10, 10, 6);
ctx.fill();
ctx.fillStyle = "red";
roundRect(270, 58, 10, 10, 6);
ctx.fill();
ctx.fillStyle = "red";
roundRect(325, 58, 10, 10, 6);
ctx.fill();
ctx.fillStyle = "red";
roundRect(465, 58, 10, 10, 6);
ctx.fill();
ctx.fillStyle = "red";
roundRect(520, 58, 10, 10, 6);
ctx.fill();
ctx.fillStyle = "red";
roundRect(655, 58, 10, 10, 6);
ctx.fill();
//end
ctx.strokeStyle = "black";
ctx.lineWidth = 2;
...
ctx.font = "bold small-caps 20px Arial";
ctx.textBaseline = "middle";
ctx.fillText("+ve", 355, 335)
// negeative terminal naming
ctx.font = "bold small-caps 20px Arial";
ctx.textBaseline = "middle";
ctx.fillText("-ve",245, 335)
ctx.beginPath();
ctx.moveTo(180, 62);
ctx.lineTo(190,48);
ctx.stroke();
...
ctx.fillStyle = "white";
ctx.beginPath();
ctx.arc(215, 120, 20, 0, 2 * Math.PI);
ctx.fill();
ctx.stroke();
...
ctx.font = "bold small-caps 20px Arial";
ctx.textBaseline = "middle";
ctx.fillText("V1",204, 123)

// resister 2 Voltmeter
ctx.strokeStyle = "black";
ctx.fillStyle = "white";
ctx.beginPath();
ctx.arc(400, 120, 20, 0, 2 * Math.PI);
ctx.fill();
ctx.stroke();
...
ctx.font = "bold small-caps 20px Arial";
ctx.textBaseline = "middle";
ctx.fillText("V2", 388, 123)

// resister 3 Voltmeter
ctx.strokeStyle = "black";
ctx.fillStyle = "white";
ctx.beginPath();
ctx.arc(595, 120, 20, 0, 2 * Math.PI);
ctx.fill();
ctx.stroke();
...
ctx.font = "bold small-caps 20px Arial";
ctx.textBaseline = "middle";
ctx.fillText("V3", 584, 123)

// resistor 1 naming
ctx.font = "bold small-caps 15px Arial";
ctx.textBaseline = "middle";
ctx.fillText("R1",180, 30)

// resistor 2 naming
ctx.font = "bold small-caps 15px Arial";
ctx.textBaseline = "middle";
ctx.fillText("R2", 350, 30)

// resistor 3 naming
ctx.font = "bold small-caps 15px Arial";
ctx.textBaseline = "middle";
ctx.fillText("R3", 565, 30)

//current naming
ctx.font = "bold small-caps 35px Arial";
ctx.textBaseline = "middle";
ctx.fillText("I", 60, 285)

//Voltmeter naming

ctx.font = "bold small-caps 15px Arial";
ctx.textBaseline = "middle";
ctx.fillText("Voltmeter 1",170, 156)

ctx.font = "bold small-caps 15px Arial";
ctx.textBaseline = "middle";
ctx.fillText("Voltmeter 2", 350, 156)

ctx.font = "bold small-caps 15px Arial";
ctx.textBaseline = "middle";
ctx.fillText("Voltmeter 3", 556, 156)
//battery naming
ctx.font = "bold small-caps 15px Arial";
ctx.textBaseline = "middle";
ctx.fillText("Supply Voltage",270, 300)
...
function resistance2Display(res){
  let text = `${res} Ω`;
  ctx.fillStyle = "white";
  ctx.fillRect(390,20,100,25);
  ctx.fillStyle = "black";
  ctx.font = "small-caps 20px Arial";
  ctx.textBaseline = "middle";
  ctx.fillText(text, 400, 30)
  ctx.fillStyle = "black";
}
...
function resistance1Display(res){
  let text = `${res} Ω`;
  ctx.fillStyle = "white";
  ctx.fillRect(220,20,70,20);
  ctx.fillStyle = "black";
  ctx.font = "small-caps 20px Arial";
  ctx.textBaseline = "middle";
  ctx.fillText(text, 238,30)
  ctx.fillStyle = "white";
}
...
function resistance3Display(res){
  let text = `${res} Ω`;
  ctx.fillStyle = "white";
  ctx.fillRect(620,20,70,25);
  ctx.fillStyle = "black";
  ctx.font = "small-caps 20px Arial";
  ctx.textBaseline = "middle";
  ctx.fillText(text, 630, 30);
  ctx.fillStyle = "black";
}
...
function voltmeter3display(V3) {
  let text = `${v3} V`;
  ctx.fillStyle = "white";
  ctx.fillRect(550,170,100,25);
  ctx.fillStyle = "black";
  ctx.font = "20px Arial";
  ctx.textBaseline = "middle";
  ctx.fillText(text, 560, 180);
  ctx.fillStyle = "black";
}
...
function voltmeter2display(v2){
  let text = `${v2} V`;
  ctx.fillStyle = "white";
  ctx.fillRect(350,170,100,25);
  ctx.fillStyle = "black";
  ctx.font = "20px Arial";
  ctx.textBaseline = "middle";
  ctx.fillText(text, 360, 180);
  ctx.fillStyle = "black";
}
...
function voltmeter1display(cur) {
  let text = `${cur} V`;
  ctx.fillStyle = "white";
  ctx.fillRect(170,170,100,25);
  ctx.fillStyle = "black";
  ctx.font = "20px Arial";
  ctx.textBaseline = "middle";
  ctx.fillText(text, 180, 180);
  ctx.fillStyle = "black";
}
...
function batteryDisplay(volt){
  let text = `${volt} V`;
  ctx.fillStyle = "white";
  ctx.fillRect(270,380,100,25);
  ctx.fillStyle = "black";
  ctx.font = "small-caps 20px Arial";
  ctx.textBaseline = "middle";
  ctx.fillText(text, 300,393)
  ctx.fillStyle = "black";
}
...
function varupdate() {
  ...
  voltageassign(volt);
  req=res1+res2+res3;
  // const circuit_current=volt/req;
...
function startSimulation(){
  ...
  document.getElementById("message").innerHTML="Set the values of supply voltage and resistors and click on Add to table to note down the readings";
...
function addtable(){
  ...
  cell1.innerHTML=volt;
  cell2.innerHTML=v1;
  cell3.innerHTML=v2;
  cell4.innerHTML=v3;
  v_1=parseFloat(v1)+parseFloat(v2)+parseFloat(v3);
  v_1=v_1.toFixed(2);
  v_1 = Number(v_1);
  cell5.innerHTML=v_1;
  cell5.classList.add("column1-font");
  document.getElementById("message").innerHTML="Click on Calculate V' to obtain the value";
